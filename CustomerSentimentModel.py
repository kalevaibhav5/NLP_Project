...
# read data
reviews_df = pd.read_csv("/Users/vaibhavkale/Documents/KSU studies MS /Fall 2022/NLP/NLP Project/1429_1.csv",usecols = ['reviews.text','reviews.rating'])
# reviews_df = pd.read_csv("../input/Hotel_Reviews.csv")
# append the positive and negative text reviews
# reviews_df["review"] = reviews_df["Negative_Review"] + reviews_df["Positive_Review"]
# create the label
reviews_df["is_bad_review"] = reviews_df["reviews.rating"].apply(lambda x: 1 if x < 4 else 0)
